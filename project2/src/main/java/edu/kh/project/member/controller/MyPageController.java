...
//클래스 레벨에 작성된  @RequestMapping은 무슨 효과가 있나요?
...
public class MyPageController {
	...
	public String updateInfo(Member inputMember, 
		...
		// inputMember : 입력 받은 memberNickname / memberTel / memberAddress
		...
		// 2. memberAddress의 값에 따라 inputMember의 address 값 변경
	...
	public String changePw(@SessionAttribute("loginMember") Member loginMember,
		   ...
		   //String currentPw, String newPw // 파라미터 각각 전달받기
	...
	@PostMapping("/delete")
	public String memberDelete(
			@SessionAttribute("loginMember") Member loginMember, String memberPw,
